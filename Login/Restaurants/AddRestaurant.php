<?php
   ...
   if($db === false){
    die("ERROR: Could not connect. " . mysqli_connect_error());
      ...
      $RDistrict = $_POST['RestaurantDistrict'];
      ...
      $sql = "INSERT INTO Restaurants (Name,district,address,type,cuisine,workinghours,details,cuisinedetails,bar,service) VALUES ('$RName','$RDistrict','$RAddress','$RType','$RCuisine','$RWH','$RDetails','$RCuisineDetails','$RBar','$RService')";
