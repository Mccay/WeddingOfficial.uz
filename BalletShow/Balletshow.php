...
<html lang="en">
 <head>
  <title>showballet</title>
  <meta charset="utf-8">
  <meta name="viewport" content="width=device-width, initial-scale=1">
  	<link href="balletshow.css" type = "text/css" rel="stylesheet">
...
<div class="container-fluid">
  ...
  <div class="row content">
    ...
    <li class="active" ><a data-toggle="pill" href="Basilic" style="nav-color:none;color:black;" >ELITA   </a></li>
	<hr>
    <li><a data-toggle="pill" href="#Marmaris" style="nav-color:none;color:black;" >Favourite   </a></li>
	<hr>
    <li><a data-toggle="pill" href="#Dar" style="nav-color:none;color:black;" >LADA       </a></li>
...
<div class="media">
  <div class="media-body"style = "padding-right:20px;">
	  ...
	  <br>
	  <h3 >Is it necessary to show ballet for a holiday? Want to order a show, do you need a dance group or are you looking for a dance group? Our site, bulletin board, will help to find the contacts of the show ballet in Tashkent ..</h3> 
...
<div id="Marmaris" class="tab-pane fade">
 <div class="col-sm-10 main" >
<h3 >
Favourite <small>  show ballet </small>
</h3>
<hr>
...
<div id="Dar" class="tab-pane fade">
 ...
 <div class="col-sm-10 main" >
<h3 >
LADA<small>  show ballet</small> </h3>
<hr>
