<?php
   ...
   if($db === false){
    die("ERROR: Could not connect. " . mysqli_connect_error());
      ...
      $sql = "INSERT INTO RestaurantsMirabad (Name,address,type,cuisine,workinghours,details,cuisinedetails,bar,service) VALUES ('$RName','$RAddress','$RType','$RCuisine','$RWH','$RDetails','$RCuisineDetails','$RBar','$RService')";
