...
for ($x = 1; $x <= 30; $x++) {
$sql[$x] = "SELECT * FROM beautysalons WHERE SalonID = $x";
for ($y = 1; $y <= 30; $y++) {
$sqlIMAGE[$x][$y] = "SELECT Path FROM BeautySalonsImages WHERE SalonID = $x AND ImageNumber = $y";
...
<small>Choose district</small>
  ...
  <ul class="dropdown-menu" style = "padding:20px; width=100px">
...
<div class="container-fluid">
  ...
  <ul class="nav nav-pills nav-stacked primary" data-spy="affix" data-offset-top="655" style="margin:10px; background-color:white ; nav-color:none;">
    <li class="active" ><a data-toggle="pill" href="#diamond" style="nav-color:none;color:black;" >Diamond    </a></li>
	<hr>
    <li><a data-toggle="pill" href="#adajio" style="nav-color:none;color:black;" >Adajio   </a></li>
	<hr>
    <li><a data-toggle="pill" href="#alfastyle" style="nav-color:none;color:black;" >Alfa-Style         </a></li>
	
  </ul>
    </div>

<div class="tab-content" >
<div id="diamond" class="tab-pane fade in active">
   ...
   <div id="map" style = "box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);"></div>
    ...
    <script>
      function myMap() {
        ...
        var uluru = {lat:41.282664, lng:69.255077};
		var uluru1 = {lat: 41.290045, lng:69.258534};
		var uluru2 = {lat: 41.289626, lng:69.274492};
    ...
    <div id="adajio" class="tab-pane fade">
     <div class="col-sm-10 main" >
<h3 >
<?php
echo $row[2]["Name"];
...
<p> </p>
   <div id="map1" style = "box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);"></div>
	...
	<div id="alfastyle" class="tab-pane fade">
     <div class="col-sm-10 main" > 
<h3 >
<?php
echo $row[3]["Name"];
...
<div class="container-fluid">
  ...
  <ul class="nav nav-pills nav-stacked primary" data-spy="affix" data-offset-top="655" style="margin:10px; background-color:white ; nav-color:none;">
    <li class="active"><a data-toggle="pill" href="#alhambra" style="nav-color:none;color:black;">Alhambra</a></li>
	<hr>
    <li><a data-toggle="pill" href="#alion" style="nav-color:none;color:black;">Alion</a></li>
	<hr>
    <li><a data-toggle="pill" href="#almaz"style="nav-color:none;color:black;">Almaz</a></li>
   
  </ul>
    </div>

<div class="tab-content" >
<div id="alhambra" class="tab-pane fade in active">
<!--Miss Kamilla-->
...
<hr>
<h3 >Address:</h3><?php echo $row[4]["Address"];?>
<p> </p>
   <div id="map1" style = "box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);"></div>
    </div>
...
<!-- Teamo-->
    <div id="alion" class="tab-pane fade">
...
<hr>
<h3>Address:</h3><?php echo $row[5]["Address"];?>
<p> </p>
   <div id="map1" style = "box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);"></div>
    </div>
    ...
    <div id="almaz" class="tab-pane fade">
	<div class="col-sm-10 main" >
<h3 >
<?php
echo $row[6]["Name"];
...
<hr>
<h3 >Address:</h3><?php echo $row[6]["Address"];?>
<p> </p>
   <div id="map1" style = "box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);"></div>
    </div>
...
<div class="container-fluid">
  ...
  <div class="row content">
    <div class="col-sm-2 navbar" style = "font-size:16px; height: auto; text-align:left;">
  <ul class="nav nav-pills nav-stacked primary" data-spy="affix" data-offset-top="655" style="margin:10px; background-color:white ; nav-color:none;">
    <li class="active" ><a data-toggle="pill" href="#antar" style="nav-color:none;color:black;" >Antar   </a></li>
	<hr>
    <li><a data-toggle="pill" href="#numberone" style="nav-color:none;color:black;" >Number one   </a></li>
	<hr>
    <li><a data-toggle="pill" href="#arthouse" style="nav-color:none;color:black;" >Art House         </a></li>
	
  </ul>
    </div>

<div class="tab-content" >
<div id="antar" class="tab-pane fade in active">
<div class="col-sm-10 main" >
<h3 >
<?php
echo $row[7]["Name"];
...
<div id="myCarousel" class="carousel slide" data-ride="carousel" style = "width:700px; height: 400px; ">
  ...
  <div class="carousel-inner" role="listbox">
    ...
    <div class="item">
      <img src="<?php echo $rowIMAGE[7][3]["Path"]; ?>" alt="dress two">
    </div>
...
<hr>
<h3 >Address:</h3><?php echo $row[7]["Address"];?>
<p> </p>
   ...
   <div id="map" style = "box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);"></div>
    ...
    <div id="numberone" class="tab-pane fade">
     <div class="col-sm-10 main" >
<h3 >
<?php
echo $row[8]["Name"];
...
<hr>
<h3>Address:</h3><?php echo $row[8]["Address"];?>
<p> </p>
   <div id="map1" style = "box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);"></div>
    </div>
  </div>
    <div id="arthouse" class="tab-pane fade">
     <div class="col-sm-10 main" >
<h3 >
<?php
echo $row[9]["Name"];
...
<hr>
<h3 >Address:</h3><?php echo $row[9]["Address"];?>
<p> </p>
   <div id="map1" style = "box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);"></div>
    </div>
    </div>
