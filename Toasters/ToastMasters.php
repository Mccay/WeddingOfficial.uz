...
<html lang="en">
 <head>
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1">
  	<link href="toastmasters.css" type = "text/css" rel="stylesheet">
...
<div class="container-fluid">
  ...
  <div class="row content">
    ...
    <li class="active" ><a data-toggle="pill" href="Basilic" style="nav-color:none;color:black;" >Ravshan Khodjiev    </a></li>
	<hr>
    <li><a data-toggle="pill" href="#Marmaris" style="nav-color:none;color:black;" >Farkhad Olimov   </a></li>
	<hr>
    <li><a data-toggle="pill" href="#Dar" style="nav-color:none;color:black;" >Artur Begloryan        </a></li>
...
<div class="media">
  <div class="media-body"style = "padding-right:20px;">
	  ...
	  <br>
	  <h3 >The leader of the event, without exaggeration, is considered the soul of the celebration. The choice of entertainers will become easier with our selection of Russian- and Uzbek-speaking leading different genres and price categories.</h3> 
	  
	  <br><br>
	  <br><br>
	  <br><br>
	  <p> Work experience: 10 years <br> Tel. number: +99890 9594555</p>
	
  </div>

  <div class="media-right media-bottom">
  
    <h4 class="media-heading" style = "font-family: Nautilus Pompilius;">Ravshan Khodjiev</h4>
  ...
  <!-- Wrapper for slides -->
      ...
      <img src="ravshan.jpg"alt="Chania">
...
<div class="media">
  <div class="media-body"style = "padding-right:20px;">
	  ...
	  <br><br>
	  <br><br>
	  <p> Work experience: 13 years <br> Tel. number:  +99890 1888878,<br> +99899 8078878</p>
	
  </div>

  <div class="media-right media-bottom">
  
    <h4 class="media-heading" style = "font-family: Nautilus Pompilius;">Farkhad Olimov</h4>
  ...
  <!-- Wrapper for slides -->
      ...
      <img src="farkhad.jpg"alt="Chania">
...
<div class="media">
  <div class="media-body"style = "padding-right:20px;">
	  ...
	  <br><br>
	  <br><br>
	  <p> Work experience: 10 years <br> Tel. number:  +99891 1663333</p>
	
  </div>

  <div class="media-right media-bottom">
  
    <h4 class="media-heading" style = "font-family: Nautilus Pompilius;"> Artur Begloryan</h4>
